...
public class D {
    ...
    void solve() throws IOException {
        ...
        for (int i = 0; i < n; ++i) {
            ...
            if (l == s) {
                v[l] = new ArrayList<Integer>();
                c[l] = new ArrayList<Integer>();
                ++s;
            }
            int cnt = 1;
            if (l > 0) {
            ...
            v[l].add(a);
            c[l].add(c[l].size() > 0 ? (cnt + c[l].get(c[l].size() - 1)) % m : cnt);
        }
        out.println(c[s - 1].get(c[s - 1].size() - 1));
